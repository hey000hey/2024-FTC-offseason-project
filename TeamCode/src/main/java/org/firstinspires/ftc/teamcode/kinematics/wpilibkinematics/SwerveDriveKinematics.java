...
package org.firstinspires.ftc.teamcode.kinematics.wpilibkinematics;
...
public class SwerveDriveKinematics {
     ...
     * {@link #normalizeWheelSpeeds(com.arcrobotics.ftclib.kinematics.wpilibkinematics.SwerveModuleState[], double) normalizeWheelSpeeds}
     * function to rectify this issue.
     */
    @SuppressWarnings({"LocalVariableName", "PMD.AvoidInstantiatingObjectsInLoops"})
    public com.arcrobotics.ftclib.kinematics.wpilibkinematics.SwerveModuleState[] toSwerveModuleStates(com.arcrobotics.ftclib.kinematics.wpilibkinematics.ChassisSpeeds chassisSpeeds,
        ...
        com.arcrobotics.ftclib.kinematics.wpilibkinematics.SwerveModuleState[] moduleStates = new com.arcrobotics.ftclib.kinematics.wpilibkinematics.SwerveModuleState[m_numModules];
        ...
        for (int i = 0; i < m_numModules; i++) {
            ...
            moduleStates[i] = new com.arcrobotics.ftclib.kinematics.wpilibkinematics.SwerveModuleState(speed, angle);
        }
    ...
    /**
     * Performs inverse kinematics. See {@link #toSwerveModuleStates(com.arcrobotics.ftclib.kinematics.wpilibkinematics.ChassisSpeeds, Translation2d)}
     ...
     */
    public com.arcrobotics.ftclib.kinematics.wpilibkinematics.ChassisSpeeds toChassisSpeeds(com.arcrobotics.ftclib.kinematics.wpilibkinematics.SwerveModuleState... wheelStates) {
        ...
        for (int i = 0; i < m_numModules; i++) {
            com.arcrobotics.ftclib.kinematics.wpilibkinematics.SwerveModuleState module = wheelStates[i];
     ...
     */
    public static void normalizeWheelSpeeds(com.arcrobotics.ftclib.kinematics.wpilibkinematics.SwerveModuleState[] moduleStates,
